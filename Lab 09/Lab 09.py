...
##### The concept used here is Class and Objects 

##### `1.` The inputs are entered and saves.
##### `2.` Various fucntions are made and those store transactions,viewing and calculating the total.
##### `3.` Menu driven option is made for making it user friendly.
